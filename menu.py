...
momo=Checkbutton(snacksframe,text='momo',variable=var11,onvalue=1,offvalue=0,font=('arial',15,'bold'),bg='#E2CCA3').grid(row=1,sticky=W)
chowmein=Checkbutton(snacksframe,text='chowmein',variable=var12,onvalue=1,offvalue=0,font=('arial',15,'bold'),bg='#E2CCA3').grid(row=2,sticky=W)
thukpa=Checkbutton(snacksframe,text='thukpa',variable=var13,onvalue=1,offvalue=0,font=('arial',15,'bold'),bg='#E2CCA3').grid(row=3,sticky=W)
pizza=Checkbutton(snacksframe,text='pizza',variable=var14,onvalue=1,offvalue=0,font=('arial',15,'bold'),bg='#E2CCA3').grid(row=4,sticky=W)
burger=Checkbutton(snacksframe,text='Burger',variable=var15,onvalue=1,offvalue=0,font=('arial',15,'bold'),bg='#E2CCA3').grid(row=5,sticky=W)
chicken_chilly=Checkbutton(snacksframe,text='Chicken chilly',variable=var16,onvalue=1,offvalue=0,font=('arial',15,'bold'),bg='#E2CCA3').grid(row=6,sticky=W)
frenchfries=Checkbutton(snacksframe,text='Fries',variable=var17,onvalue=1,offvalue=0,font=('arial',15,'bold'),bg='#E2CCA3').grid(row=7,sticky=W)
pasta=Checkbutton(snacksframe,text='Pasta',variable=var18,onvalue=1,offvalue=0,font=('arial',15,'bold'),bg='#E2CCA3').grid(row=8,sticky=W)
...
txtchicken_chilly=Entry(snacksframe,font=('arial',11,'bold'),bd=8,width=6,justify=LEFT,state=DISABLED)
...
def next():
    ...
    billtitle = Label(frame2, font=('arial', 40, 'bold'), text="Billing system", bd=10, bg='#E2CCA3', fg='#423930')
